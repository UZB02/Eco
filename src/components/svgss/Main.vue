<template>
    <div class="svg">
                <!-- instagram -->
                <a href="https://www.instagram.com/eco_clean_nmg/"> <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                ...
                <a href="https://t.me/eco_clean_nmg" class="w-12">
...
.svg a:nth-child(1) svg {
    border-radius: 50%;
    animation: animInsta 2s infinite linear;
}
...
@keyframes animInsta {
    ...
    50% {
        box-shadow: inset 0px 0px 10px 5px rgb(233, 13, 163);
    }
...
.svg a:nth-child(2) img {
    border-radius: 50%;
    animation: animTeg 2s infinite linear;
}
...
@keyframes animTeg {
    ...
    50% {
        box-shadow: inset 0px 0px 10px 5px rgb(32, 134, 244);
    }
